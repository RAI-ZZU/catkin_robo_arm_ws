...
class InterbotixRobotXSCore(object):
    def __init__(self, robot_model, robot_name=None, init_node=True, joint_state_topic="joint_states"):
        ...
        topic_name = "/" + self.robot_name + "/" + joint_state_topic
        self.sub_joint_states = rospy.Subscriber(topic_name, JointState, self.joint_state_cb)
        print(f"DEBUG: Subscribing to: {topic_name}")
